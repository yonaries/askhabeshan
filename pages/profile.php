...
?>
<?php
    $profileuser=$_SESSION['currentuser_id'];
    $getposts = "SELECT * FROM `user_post` WHERE user_id = '$profileuser' ORDER BY post_id DESC";
    $getuseraccount = "SELECT * FROM `users` WHERE user_id = '$profileuser'";
    $fetchpost = mysqli_query($conn,$getposts);
    $fetchuseraccount = mysqli_query($conn,$getuseraccount);
...
?>
<?php
if($fetchuseraccount ->num_rows > 0){
    $row = mysqli_fetch_assoc($fetchuseraccount);
        $profileusername = $row['Username'];
        $profileuseremail = $row['Email'];
        $profileuserpassword = $row['Password'];
    }
?>
<?php
...
<head>
    ...
    <link rel = "icon" href = "../assets/illustrations/logo.jpg" 
        type = "image/x-icon">
</head>
    ...
    <div class="container">
        ...
        <div class="left-side">
            <div class="catagory">
                <p>Catagories</p>
                <?php
                for($i=0;$i<$fetchcategory2 ->num_rows;$i++){
                ...
                <div class="hello-text">
                    <div class="current-container">
                        <div class="current-info">
                            <h2><span><?php echo $_SESSION['user'];?></span></h2>
                            <div class="info">
                                <p>User ID: <span>user<?php echo $profileuser ?></span></p>    
                                <p>Email: <span><?php echo $profileuseremail ?></span></p>    
                            </div>
                        </div>
                        <div class="current-info">
                              <img src="../assets/icons/user.png" /> 
                    ...
                    <button class="editbtn" onclick="editProfileToggle()">UPLOAD IMAGE</button>
                    <div class="form-container">
                        <div id="edit-btn" onclick="editProfileToggle()">UPDATE ACCOUNT</div>
                        <form class="editform" action="" method="post">
                            <label for="username">Username</label><br>
                            <div class="input-field">
                                <input type="text" name="prousername" placeholder="Your new username">
                            </div>
                            <label for="username">Email</label><br>
                            <div class="input-field">
                                <input type="text" name="proemail" placeholder="Your new email">
                            </div>
                            <label for="username">Password</label><br>
                            <div class="input-field">
                                <input type="text" name="propass" placeholder="Your new password">
                            </div>
        ...
        <!--    --------post-bar-------->
            ...
            ?>
                ...
                <?php           
                 ...
                 else { ?><div class="no-post"><h2><?php echo "You have Questions,<br> Ask Your First.";?></h2></div><?php }
                ?>
